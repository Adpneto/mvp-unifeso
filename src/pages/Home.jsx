...
export default function Home() {
    const { user, addAgendamento } = useAuth()
    ...
    const handleAgendar = (addAgendamento) => {
        const agendamentoData = { data: formattedDate, horario: selectedItem}
                ...
                <HomeContent>
                    ...
                    >
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant="secondary" onClick={() => handleAgendar(addAgendamento)}>Agendar</Button>
                        </Modal.Footer>
                    </Modal>
                </HomeContent>
                <Services></Services>
